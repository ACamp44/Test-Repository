...
class PublicUserApiTests(TestCase):
    #Test Public feautures of USER API 

    def setUp(self):
        self.client = APIClient()
    
    def test_create_user_success(self):
        #Test creating user a success
        payload = {
    ...
    def test_user_with_email_exists_error(self):
        #return error if user with email exists
        payload = {
            'email': 'test@example.com',
            'password': 'testpass123',
            'name': 'Test Name',
    ...
    def test_create_token_for_user(self):
        #generates token for valid credential 
        user_details = {
            'name': 'Test Name',
            'email': 'test@example.com',
    ...
    def test_create_token_blank_password(self):
        #Test positng a blank password returns an error
